...
public class CharacterData : ScriptableObject
{
	...
	[field: Header("State Sprites (Optional)")]
	[field: Tooltip("Idle pose. Falls back to characterSprite if null.")]
	[field: SerializeField] public Sprite idleSprite { get; private set; }
	[field: Tooltip("Shown when playing an Attack card.")]
	[field: SerializeField] public Sprite activeActionSprite { get; private set; }
	[field: Tooltip("Shown when playing any non-Attack card.")]
	[field: SerializeField] public Sprite passiveActionSprite { get; private set; }
	[field: Tooltip("Shown when taking damage.")]
	[field: SerializeField] public Sprite damageTakenSprite { get; private set; }
	[field: Tooltip("How long action/damage pose sprites are shown before returning to idle.")]
